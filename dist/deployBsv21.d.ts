...
import type { Distribution, IconInscription, Utxo } from "./types";
/**
 ...
 */
export declare const deployBsv21Token: (symbol: string, icon: string | IconInscription, utxos: Utxo[], initialDistribution: Distribution, paymentPk: PrivateKey, destinationAddress: string, changeAddress?: string, satsPerKb?: number) => Promise<Transaction>;
